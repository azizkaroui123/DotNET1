...
namespace ENISNC.Controllers
{
    public class PapersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Type,Staus,demanded_at,approved_at")] Paper paper)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type,Staus,demanded_at,approved_at")] Paper paper)
        {
            if (id != paper.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ENISContext.Paper'  is null.");
            }
            var paper = await _context.Paper.FindAsync(id);
            if (paper != null)
            {
