...
namespace ENISNC.Controllers
{
    public class SectionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,sectionName,Grade,schoolYear")] Section section)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,sectionName,Grade,schoolYear")] Section section)
        {
            if (id != section.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ENISContext.Section'  is null.");
            }
            var section = await _context.Section.FindAsync(id);
            if (section != null)
            {
