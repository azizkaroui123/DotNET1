...
namespace ENISNC.Controllers
{
    public class DepartementsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,spacialitée")] Departement departement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,spacialitée")] Departement departement)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ENISContext.Departement'  is null.");
            }
            var departement = await _context.Departement.FindAsync(id);
            if (departement != null)
            {
